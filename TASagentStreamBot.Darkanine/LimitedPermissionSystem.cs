...
public class LimitedPermissionSystem : ICommandContainer
{
    private readonly Core.ICommunication communication;
    private readonly IServiceScopeFactory scopeFactory;

    public LimitedPermissionSystem(
    ...
    private async Task AdjustUser(Core.IRC.TwitchChatter chatter, string[] remainingCommand, bool elevate)
    {
    ...
    private async Task ModUser(Core.IRC.TwitchChatter chatter, string[] remainingCommand, bool mod)
    {
    ...
    private async Task RestrictUser(Core.IRC.TwitchChatter chatter, string[] remainingCommand)
    {
        if (chatter.User.AuthorizationLevel < AuthorizationLevel.Moderator)
        {
